...
class preFinalScreen extends JFrame
{   private JLabel labeldate,labelloc,labelprice,labelpricedet1,labelpricedet2,labelpricedet3,labelinfo;
    ...
    preFinalScreen()
    {
        ...
        finalprice="Final amount to be paid: "+fprice/1000+","+fprice%1000;
        pricedet="\n1x ticket rate for passengers above age 12, 0.5x ticket rate for passengers between ages 5 & 12 and No ticket for passengers below age 5";
        panel3 = new JPanel();
        ...
        labelpricedet1 = new JLabel("1x ticket rate for passengers above age 12");
        labelpricedet1.setAlignmentX(JLabel.CENTER_ALIGNMENT);
        panel3.add(labelpricedet1);
        labelpricedet2 = new JLabel("0.5x ticket rate for passengers between ages 5 & 12");
        labelpricedet2.setAlignmentX(JLabel.CENTER_ALIGNMENT);
        panel3.add(labelpricedet2);
        labelpricedet3 = new JLabel("No ticket for passengers below age 5");
        labelpricedet3.setAlignmentX(JLabel.CENTER_ALIGNMENT);
        panel3.add(labelpricedet3);
        ...
        buttonbuy.addMouseListener(new eventnext());
        emptylabel[4] = new JLabel("             ");
        panel4.add(emptylabel[4]);
        buttonback = new JButton("Back");
        buttonback.addMouseListener(new eventback());
    ...
    public class eventnext implements MouseListener {
    ...
    public class eventback implements MouseListener {
        public void mouseClicked(MouseEvent e) {
            panel1.setVisible(false);panel2.setVisible(false);panel3.setVisible(false);panel4.setVisible(false);
